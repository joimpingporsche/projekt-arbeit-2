...
\input{tables/features_channels}
  ...
  \begin{align*}
\text{Fahrzeugbalance} = \frac{L \cdot a_y}{v^2} - \delta
\end{align*}

$L$ ist der Radstand in [m], $a_y$ ist die Querbeschleunigung in [m/s$^2$], 
$v$ ist die Fahrtgeschwindigkeit in [m/s] und $\delta$ ist der Lenkwinkel in [rad].
