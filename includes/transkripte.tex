\anhangteil{Erstes Meeting mit Performance-Ingenieur*in am 29.08.2025}
\label{transkript-meeting1}

\textbf{Experte:} Teamleiter*in Performance Engineering (LMDh-Programm), Porsche Motorsport

\linenumbers

\textbf{Interviewer*in: Meeting-Eröffnung}
Vielen Dank für deine Zeit. Könntest du dich bitte kurz vorstellen?

\textbf{Ingenieur*in: Vorstellung und Aufgabengebiet}
...
\textbf{Interviewer*in: Definition und Aufgaben des Performance Engineers}
...
\textbf{Ingenieur*in: Rolle und Setup-Optimierung}
...
\textbf{Ingenieur*in: Daten und Setup-Entscheidung}
...
\textbf{Interviewer*in: Prozess am Rennwochenende}
...
\textbf{Ingenieur*in: Simulation und Validierung}
...
\textbf{Ingenieur*in: Setup-Umsetzung}
...
\textbf{Interviewer*in: Überleitung zum Machine Learning (ML) Projekt}
...
\textbf{Interviewer*in: Erläuterung ML-Typen (Klassifikation)}
...
\textbf{Interviewer*in: Erläuterung ML-Typen (Regression/Vorhersage)}
...
\textbf{Interviewer*in: Erläuterung Trainingsdaten und Labeling}
...
\textbf{Ingenieur*in: Rundenzeit-Vorhersage und Alternativen}
...
\textbf{Ingenieur*in: Herausforderung und Ideen (Reifen/Setup)}
...
\textbf{Ingenieur*in: Fahrer-Feedback und Reifenüberhitzung}
...
\textbf{Interviewer*in: Potential des ML-Modells}
...
\textbf{Ingenieur*in: Labelling als Problem und alternative Kennwerte}
...
\textbf{Ingenieur*in: Kennwert Snaps}
...
\textbf{Ingenieur*in: Long-Run-Daten und Lebensdauer-Prognose}
...
\textbf{Interviewer*in: Präzisierung der Prognose-Idee}
...
\textbf{Ingenieur*in: Einschränkung der Datenbasis}
...
\textbf{Ingenieur*in: Empfehlung für Proof of Concept (POC)}
...
\textbf{Interviewer*in: Fehlerhafte Temperatursensoren}
...
\textbf{Ingenieur*in: Kritischer Grenzwert und Sensorfehler}
...
\textbf{Interviewer*in: Abschluss und nächster Termin}
...
\textbf{Ingenieur*in: Wunsch für nächstes Meeting}
...
\textbf{Interviewer*in: Abschluss}
...
\anhangteil{Zweites Meeting mit Performance-Ingenieur*in am 12.09.2025}
...
\textbf{Interviewer*in: Problemstellung Reifendegradation und neuer Ansatz}
...
\textbf{Interviewer*in: Neue Idee: Fahrerfeedback / Explainability AI}
...
\textbf{Ingenieur*in: Vorschlag: Fokus auf Fahrzeugbalance (Car Balance)}
...
\textbf{Ingenieur*in: Modellierung der Balance}
...
\textbf{Interviewer*in: Definition Balance}
Was genau ist diese Balance?

\textbf{Ingenieur*in: Erklärung der Car Balance}
...
\textbf{Ingenieur*in: Der Kern der Fragestellung}
...
\textbf{Ingenieur*in: Beispiel Streckentemperatur}
...
\textbf{Interviewer*in: Bewertung des Car Balance Themas}
...
\textbf{Ingenieur*in: Update zum Degradations-Kennwert}
...
\textbf{Ingenieur*in: Modellierung des Degradations-Kennwerts}
...
\textbf{Interviewer*in: Rückkehr zum Car Balance POC}
...
\textbf{Ingenieur*in: Empfehlung für POC-Umfang}
...
\textbf{Ingenieur*in: Datenverfügbarkeit und Mileage}
...
\textbf{Ingenieur*in: Allgemeiner Problemkern}
...
\anhangteil{Methodische Anmerkungen zu den Interviews}
