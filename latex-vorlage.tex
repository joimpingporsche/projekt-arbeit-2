...
\input{includes/chapter/1_einleitung.tex}
\input{includes/chapter/2_grundlagen.tex}
\input{includes/chapter/3_relevance_cycle.tex}
\input{includes/chapter/4_design_cycle.tex}
\input{includes/chapter/5_rigor_cycle.tex}
\input{includes/chapter/6_ergebnisse_diskussion.tex}
\input{includes/chapter/7_explainable_ai.tex}
\input{includes/chapter/8_Fazit_Ausblick.tex}
